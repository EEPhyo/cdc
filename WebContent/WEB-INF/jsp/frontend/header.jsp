					...
					<div class="header__content">
						...
						<div class="header__menu">
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									<a href="product.html" class="header__nav-link">Products</a>
								</li>
								
								<li class="header__nav-item">
									<a class="header__nav-link" href="#" role="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Chill Session<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"/></svg></a>
									
									<ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu">
										<li><a href="#">Chill Session 1.0</a></li>
										<li><a href="#">Chill Session 2.0</a></li>
									</ul>
								</li>
								
								<li class="header__nav-item">
									<a class="header__nav-link" href="#" role="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Event<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17,9.17a1,1,0,0,0-1.41,0L12,12.71,8.46,9.17a1,1,0,0,0-1.41,0,1,1,0,0,0,0,1.42l4.24,4.24a1,1,0,0,0,1.42,0L17,10.59A1,1,0,0,0,17,9.17Z"/></svg></a>
									
									<ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu">
										<li><a href="#">Pop Up Store</a></li>
										<li><a href="#">Unlpugged Chill Session</a></li>
									</ul>
								</li>
						...
						<div class="header__actions">
							<div class="header__action">
								<a class="header__profile-btn" href="#" role="button" id="dropdownMenuProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<svg xmlns="" viewBox="0 0 24 24"><path d="M15.71,12.71a6,6,0,1,0-7.42,0,10,10,0,0,0-6.22,8.18,1,1,0,0,0,2,.22,8,8,0,0,1,15.9,0,1,1,0,0,0,1,.89h.11a1,1,0,0,0,.88-1.1A10,10,0,0,0,15.71,12.71ZM12,12a4,4,0,1,1,4-4A4,4,0,0,1,12,12Z"/></svg>
								</a>
						...
						<div class="header__actions">
							<div class="header__action">
								...
								<ul class="dropdown-menu header__profile-menu" aria-labelledby="dropdownMenuProfile">
									<li><a href="cart.html">Checkout&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-shopping-bag"></i></a></li>
								</ul>
							</div>
						</div>
